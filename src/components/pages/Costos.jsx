...
/**
 * Grilla de costos por producto. Comparte el catalogo con Recetas, asi que son
 * exactamente las mismas tarjetas.
 *
 * Todavia no existe la pantalla de costo de cada producto: las tarjetas apuntan
 * a `/costos/:slug`, que hoy cae en el 404 y se completa mas adelante.
 */
const Costos = () => {
  ...
  return (
    <div className="container py-4">
      <div className="mx-auto" style={{ maxWidth: "650px", width: "100%" }}>
        {/* Header */}
        <h2 className="mush-display text-white text-center mb-3">Costos</h2>

        {/* Grid de 9 Tarjetas (3x3 fija y proporcionada) */}
        <div className="row g-2 g-sm-3">
          {listaBotones.map((p) => (
            <div className="col-4" key={p.slug}>
              <Link
                to={`/costos/${p.slug}`}
                ...
                title={`Ver costos de ${p.nombre}`}
              >
                <span className="fs-2 mb-2">{p.imagen}</span>
                <strong
